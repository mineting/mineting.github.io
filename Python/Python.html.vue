<template><div><div align='center'><font size='70'><b>Python</b></font></div>
<h1 id="python-简介" tabindex="-1"><a class="header-anchor" href="#python-简介" aria-hidden="true">#</a> Python 简介</h1>
...
<ul>
<li><strong>Python 是一种解释型语言：</strong> 这意味着开发过程中没有了编译这个环节。类似于 PHP 和 Perl 语言。</li>
<li><strong>Python 是交互式语言：</strong> 这意味着，您可以在一个 Python 提示符 <strong>&gt;&gt;&gt;</strong> 后直接执行代码。</li>
<li><strong>Python 是面向对象语言:</strong> 这意味着 Python 支持面向对象的风格或代码封装在对象的编程技术。</li>
<li>**Python 是初学者的语言：**Python 对初学者而言，是一种伟大的语言，它支持广泛的应用程序开发，从简单的文字处理到 WWW 浏览器再到游戏。</li>
</ul>
<h2 id="python-发展历史" tabindex="-1"><a class="header-anchor" href="#python-发展历史" aria-hidden="true">#</a> Python 发展历史</h2>
...
<h2 id="python-安装" tabindex="-1"><a class="header-anchor" href="#python-安装" aria-hidden="true">#</a> Python 安装</h2>
<p>下载地址：<a href="https://www.python.org/downloads/" target="_blank" rel="noopener noreferrer">https://www.python.org/downloads/<ExternalLinkIcon/></a></p>
<h3 id="windows" tabindex="-1"><a class="header-anchor" href="#windows" aria-hidden="true">#</a> Windows</h3>
<p>双击运行，选择安装位置。</p>
<h3 id="centos-安装" tabindex="-1"><a class="header-anchor" href="#centos-安装" aria-hidden="true">#</a> CentOS 安装</h3>
<p>CentOS、Ubuntu 默认安装 Python2.7</p>
<p>源码编译安装 Python3.10</p>
<p>地址：<a href="https://www.python.org/downloads/" target="_blank" rel="noopener noreferrer">https://www.python.org/downloads/<ExternalLinkIcon/></a></p>
<p>依赖程序：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>安装步骤：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> https://www.python.org/ftp/python/3.10.11/Python-3.10.11.tgz
...
<p>yum 默认使用 python2 作为依赖，安装 python3 后，需要对 yum 进行修改，确保 yum 不会受到影响。</p>
<p>修改以下两个文件的首行解释器版本，将 #! /usr/bin/python 改为 #! /usr/bin/python2：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">vim</span> /usr/libexec/urlgrabber-ext-down
<span class="token function">vim</span> /usr/bin/yum
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="python-解释器" tabindex="-1"><a class="header-anchor" href="#python-解释器" aria-hidden="true">#</a> python 解释器</h2>
<p>解释执行 python 代码：</p>
<p>新建 py 文件：<a href="http://demo.py" target="_blank" rel="noopener noreferrer">demo.py<ExternalLinkIcon/></a></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 python 执行：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>python <span class="token operator">/</span>opt<span class="token operator">/</span>python3<span class="token operator">/</span>demo<span class="token punctuation">.</span>py
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="python-ide-pycharm" tabindex="-1"><a class="header-anchor" href="#python-ide-pycharm" aria-hidden="true">#</a> Python IDE：Pycharm</h2>
<p>下载地址：<a href="https://www.jetbrains.com/pycharm/" target="_blank" rel="noopener noreferrer">https://www.jetbrains.com/pycharm/<ExternalLinkIcon/></a></p>
<p>常见设置：</p>
<ol>
<li>
<p>鼠标缩放字体</p>
<p>同样搜索 increase Font Size 设置增加字体：Ctrl + Wheel + Up</p>
</li>
<li>
<p>安装 translation 插件，鼠标选中后点击右键进行翻译</p>
</li>
<li>
<p>设置文件编码</p>
</li>
</ol>
<h1 id="python-基础" tabindex="-1"><a class="header-anchor" href="#python-基础" aria-hidden="true">#</a> Python 基础</h1>
<h2 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法</h2>
<h3 id="print-函数" tabindex="-1"><a class="header-anchor" href="#print-函数" aria-hidden="true">#</a> print 函数</h3>
<ul>
<li>输出字符串（单引号和双引号都可以）</li>
<li>输出数字（整数和浮点数）</li>
<li>输出内容到文件中</li>
</ul>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># print</span>
...
<ul>
<li>单行注释：# ，建议在 # 后添加空格</li>
<li>多行注释（三个引号（单引号、双引号）之间的内容）：&quot;&quot;&quot;	&quot;&quot;&quot;</li>
<li>中文编码注释：在文件开头使用 # coding:utf-8 指定文件的编码格式</li>
</ul>
<p>示例：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="关键字" tabindex="-1"><a class="header-anchor" href="#关键字" aria-hidden="true">#</a> 关键字</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="缩进" tabindex="-1"><a class="header-anchor" href="#缩进" aria-hidden="true">#</a> 缩进</h3>
<p>一般使用 4 个空格作为缩进</p>
<h3 id="换行" tabindex="-1"><a class="header-anchor" href="#换行" aria-hidden="true">#</a> 换行</h3>
<p>单行语句换行：使用  \</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token builtin">str</span> <span class="token operator">=</span> <span class="token string">"My First "</span> \
      <span class="token string">"Python Program!"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="引号" tabindex="-1"><a class="header-anchor" href="#引号" aria-hidden="true">#</a> 引号</h3>
<p>单引号和双引号都可以定义字符串，三个引号代表注释</p>
<h3 id="输入与输出" tabindex="-1"><a class="header-anchor" href="#输入与输出" aria-hidden="true">#</a> 输入与输出</h3>
<ul>
<li>input()</li>
<li>print()</li>
</ul>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 输入与输出</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="转义字符" tabindex="-1"><a class="header-anchor" href="#转义字符" aria-hidden="true">#</a> 转义字符</h3>
<p>当字符串中含有特殊字符时，需要对特殊字符进行转义。</p>
<ul>
<li>\n    换行</li>
<li>\&quot;    转义引号</li>
<li>\t    制表位</li>
<li>\r    覆盖，后面的字符会覆盖前面的字符</li>
<li>\b    删除，删除前面一个字符</li>
<li>\\     两个 \ 表示一个 \</li>
<li>raw 字符：在字符串前面添加 r 或者 R 后，字符串中的转义字符不生效，但是字符串最后的引号不能被转义。</li>
</ul>
<p>示例：</p>
...
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">r"Hello\rPython\\"</span><span class="token punctuation">)</span>  <span class="token comment"># Hello\rPython\\</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="变量与数据类型" tabindex="-1"><a class="header-anchor" href="#变量与数据类型" aria-hidden="true">#</a> 变量与数据类型</h2>
<h3 id="变量命名规则" tabindex="-1"><a class="header-anchor" href="#变量命名规则" aria-hidden="true">#</a> 变量命名规则</h3>
<ul>
<li>
<p>变量名只能是数字、字母、下划线，且不能以数字开头</p>
</li>
<li>
<p>不能是关键字，且区分大小写</p>
</li>
</ul>
<p><strong>变量定义和声明</strong></p>
<p>变量由三部分组成：</p>
<ul>
<li>标识：表示对象所存储的内存地址，使用内置函数 id(obj) 来获取</li>
<li>类型：表示的是对象的数据类型，使用内置函数 type(obj) 来获取</li>
<li>值：表示对象所存储的具体数据，使用 print(obi) 可以将值进行打印输出</li>
</ul>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>serial <span class="token operator">=</span> <span class="token string">"Python"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>变量声明</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数据类型" tabindex="-1"><a class="header-anchor" href="#数据类型" aria-hidden="true">#</a> 数据类型</h3>
<p>Python3 中有 6 个标准的数据类型: Number（数字）、String（字符串）、List（列表）、Tuple（元组）、Set（集合）、Dictionary（字典）。其中：</p>
<ul>
<li>不可变数据：Number、String、Tuple</li>
<li>可变数据：List、Dictionary、Set</li>
</ul>
<p>常用的数据类型：整数类型、浮点类型、布尔类型（True、False）、字符串类型</p>
<p>整数的表示方式：</p>
<ul>
<li>十进制：默认</li>
<li>二进制：以 0b 开头</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>浮点数：</p>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 浮点类型</span>
...
<ul>
<li>默认使用 True 和 False</li>
<li>可以转换为 1 和 0</li>
</ul>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 布尔类型</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>字符串示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 字符串</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数据类型转换" tabindex="-1"><a class="header-anchor" href="#数据类型转换" aria-hidden="true">#</a> 数据类型转换</h3>
<p>通过类型转换函数 str()、int()、float() 完成整数、浮点数、字符串之间的转换。</p>
<p>注意：print() 函数中的加号 +  不做自动类型转换。</p>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># + 号不能自动转换为字符串，需要使用 str() 函数将其他数据转为字符串</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>input() 函数使用示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># input() 函数</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="运算符" tabindex="-1"><a class="header-anchor" href="#运算符" aria-hidden="true">#</a> 运算符</h2>
<h3 id="算术运算符" tabindex="-1"><a class="header-anchor" href="#算术运算符" aria-hidden="true">#</a> 算术运算符</h3>
<p><code v-pre>+	-	*	/(除，保留小数)	//(整除)	%	**(次方)</code></p>
<p>示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="赋值运算符" tabindex="-1"><a class="header-anchor" href="#赋值运算符" aria-hidden="true">#</a> 赋值运算符</h3>
<ul>
<li>支持链式赋值：a = b = c = 10</li>
<li>支持参数赋值：+=、-=、*=、/=、/=、//=、%=</li>
<li>支持解包赋值：a, b, c = 1, 2, 3</li>
</ul>
<p>示例：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 赋值运算符</span>
